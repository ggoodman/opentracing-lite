...
const CARRIER_KEY_SPAN_ID = 'x-tracer-span-ids';
...
class Tracer extends Opentracing.Tracer {
    ...
    _extract(format, carrier) {
        ...
        const spanId = carrier[Tracer.CARRIER_KEY_SPAN_ID];
    ...
    _inject(spanContext, format, carrier) {
        ...
        carrier[Tracer.CARRIER_KEY_SPAN_ID] = spanContext.spanId;
...
Tracer.CARRIER_KEY_SPAN_ID = CARRIER_KEY_SPAN_ID;
Tracer.SPAN_DELIMITER = SpanContext.DELIMITER;
